...
Sketchfab.prototype = {
    ...
    init: function init(urlid, options) {
        ...
        this._target.onload = function (e) {
            var title = e.currentTarget.contentDocument.title;
            if (title.startsWith('Page not found') || title.startsWith('400 - ')) {
                this.error.call(this, 'Model not found ' + urlid);
            }
        }.bind(this);
...
//# sourceMappingURL=sketchfab-viewer-1.1.0.js.map